...
<p align = "justify"> &emsp;&emsp; A seguir está demonstrada uma estrutura de buscas da prefeitura de Concórdia, que não está de acordo com o princípio de Simplicidade, pois é possível simplificar essa tarefa complexa, reestruturando-a em unidades menores e que atendam ao mesmo objetivo original pensado.</p>

<center>
<img src="../../images/principios_de_diretrizes/image1.png" width="500px">
<h6 align = "center">Figura 1: Foto da estruturas de buscas da prefeitura de Concórdia.</h6>
...
<p align = "justify"> &emsp;&emsp;Esse princípio é observado na seguinte funcionalidade de Consulta de Processo Digital, onde são previstas todas as necessidades dos usuários e disponibilizadas aos mesmos para utilização.</p>

<center>
<img src="../../images/principios_de_diretrizes/image2.png" width="500px">
<h6 align = "center">Figura 3: Página que demonstra o princípio da antecipação.</h6>
<h6 align = "center">Fonte: Autor.</h6>
</center>
...
<p align = "justify"> &emsp;&emsp;É demonstrado na Figura 4 esse princípio, onde o sistema torna o mais claro e direto possível as necessidades para um funcionamento correto de uma tarefa, evitando a memorização excessiva do usuário.</p>
...
* **O tópico da qualidade:** Afirma que não devemos dizer nada que saibamos não ser verdade ou para o que não tenhamos evidências, ou seja, não devemos mentir ou especular. 
* **O tópico da quantidade:** Diz respeito à quantidade de informação comunicada: a contribuição de uma fala deve ser tão informativa quanto necessário para os objetivos da conversa, e não mais. Uma constante dentre os profissionais de IHC é a busca pela simplicidade da interface. Seguem o lema “menos é mais”.
* **O tópico da relação ou relevância** Afirma que tudo o que for dito deve ter relação clara com os tópicos da conversa até o momento e ser relevante ao objetivo dos interlocutores. 
* **O tópico da clareza** pede para evitar a prolixidade e ambiguidade, buscar a concisão e ordenar adequadamente a conversa.
