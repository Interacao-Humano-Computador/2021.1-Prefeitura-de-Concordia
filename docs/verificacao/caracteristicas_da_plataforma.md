...
| Número | Questão |
|---|---|
| 1 | O documento apresenta os requisitos necessários para o funcionamento da plataforma? |
| 2 | O documento apresenta a portabilidade do sistema? |
| 3 | São especificadas as tecnologias utilizadas da aplicação? |
| 4 | Está presente no documento as principais funcionalidades do sistema? |
| 5 | O documento apresenta as principais restrições do sistema? |
| 6 | As principais caractéristicas negativas da aplicação estão apresentadas? |
...
<center>
<iframe width="600" height="371" seamless frameborder="0" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRtNszcbO41oGCV9pO9IyqSPR4YVXI3taHdkrXEbTQ2YNeAUQ97XLm_LexRWBTBGiAaSWQNwf2260ES/pubchart?oid=1958402719&amp;format=interactive"></iframe>
</center>
